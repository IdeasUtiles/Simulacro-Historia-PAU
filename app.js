...
function renderMC(q, sess, body){
  ...
  btn.onclick = ()=>{
    ...
    fb.appendChild(el("div",{class:"note",style:"margin-top:8px"},[
      (ok ? "✔️ Por qué es correcta: " : "📌 Qué aprender aquí: ")+(q.exp || "")
    ]));
    btn.disabled = true;
  };
...
function renderCloze(q, sess, body){
  ...
  btnCheck.onclick = ()=>{
    ...
    fb.appendChild(el("div",{class:"note",style:"margin-top:8px"},[
      (okAll ? "✔️ Por qué cuadra: " : "📌 Qué aprender aquí: ")+(q.exp || "")
    ]));
    // Full solution
...
function renderMatch(q, sess, body){
  ...
  btnCheck.onclick = ()=>{
    ...
    fb.appendChild(el("div",{class:"note",style:"margin-top:8px"},[
      (okAll ? "✔️ Por qué funciona: " : "📌 Qué aprender aquí: ")+(q.exp || "")
    ]));
    btnCheck.disabled = true;
  };
...
function renderOrder(q, sess, body){
  ...
  btn.onclick = ()=>{
    ...
    fb.appendChild(el("div",{class:"note",style:"margin-top:8px"},[
      (okAll ? "✔️ Por qué: " : "📌 Qué aprender aquí: ")+(q.exp || "")
    ]));
    if(!okAll){
